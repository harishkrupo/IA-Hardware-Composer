...
bool DrmDisplay::InitializeDisplay() {
  ...
  std::vector<uint8_t*> DrmDisplay::FindExtendedBlocksForTag(uint8_t* edid, uint8_t block_tag) {
  ...
  void DrmDisplay::DrmConnectorGetDCIP3Support(const ScopedDrmObjectPropertyPtr &props) {
