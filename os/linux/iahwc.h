...
enum iahwc_function_descriptors {
  ...
  IAHWC_FUNC_GET_DISPLAY_INFO,
  IAHWC_FUNC_GET_DISPLAY_NAME,
  IAHWC_FUNC_GET_DISPLAY_CONFIGS,
  IAHWC_FUNC_SET_DISPLAY_GAMMA,
  IAHWC_FUNC_SET_DISPLAY_CONFIG,
  IAHWC_FUNC_GET_DISPLAY_CONFIG,
...
typedef int (*IAHWC_PFN_GET_DISPLAY_INFO)(iahwc_device_t*,
                                          iahwc_display_t display_handle,
                                          uint32_t config, int attribute,
                                          int32_t* value);
typedef int (*IAHWC_PFN_GET_DISPLAY_NAME)(iahwc_device_t*,
                                          iahwc_display_t display_handle,
                                          uint32_t* size, char* name);
typedef int (*IAHWC_PFN_GET_DISPLAY_CONFIGS)(iahwc_device_t*,
                                             iahwc_display_t display_handle,
                                             uint32_t* num_configs,
                                             uint32_t* configs);
typedef int (*IAHWC_PFN_SET_DISPLAY_GAMMA)(iahwc_device_t*,
                                           iahwc_display_t display_handle,
                                           float r, float g, float b);
typedef int (*IAHWC_PFN_SET_DISPLAY_CONFIG)(iahwc_device_t*,
                                            iahwc_display_t display_handle,
                                            uint32_t config);
typedef int (*IAHWC_PFN_GET_DISPLAY_CONFIG)(iahwc_device_t*,
                                            iahwc_display_t display_handle,
                                            uint32_t* config);
